...
public class NewReleaseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NewReleaseAdapter(ArrayList<MovieModel> dataItems, OnItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == TYPE_SHIMMER) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.new_release_movie_item, parent, false);
