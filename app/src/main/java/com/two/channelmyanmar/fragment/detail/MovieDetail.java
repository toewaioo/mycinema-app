...
public class MovieDetail extends BaseThemeFragment {
    ...
    public static MovieDetail newInstance(String baseUrl) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.movie_detail_fragment_parent, container, false);
    }
    @Override
    ...
    private void addChildFragment(String text) {
        MovieChildFragment newFragment = MovieChildFragment.newInstance(text);
        FragmentTransaction transaction = getChildFragmentManager().beginTransaction();
        transaction.setCustomAnimations(R.anim.fade_in, R.anim.fade_out);
        // Find the current fragment (if any) and hide it.
        Fragment currentFragment = getChildFragmentManager().findFragmentById(R.id.movie_fragment_parent_container);
        if (currentFragment != null) {
            transaction.hide(currentFragment);
        }
        // Add the new fragment with a unique tag.
        transaction.add(R.id.movie_fragment_parent_container, newFragment, text);
