package com.two.channelmyanmar.ui.movie;
...
import com.two.channelmyanmar.databinding.FragmentDashboardBinding;
import com.two.channelmyanmar.databinding.MovieFragmentBinding;
...
import com.two.my_libs.loadmorewrapper.LoadMoreAdapter;
import com.two.my_libs.loadmorewrapper.LoadMoreWrapper;
...
public class MovieFragment extends BaseThemeFragment {
    ...
    private MovieFragmentBinding binding; // View Binding
    ...
    private void setupRecyclerView() {
        ...
        binding.movieRecycler.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
    ...
    private void setupPtrFrame() {
        ...
        binding.storeHousePtrFrame.addPtrUIHandler(new PtrUIHandler() {
        ...
        binding.storeHousePtrFrame.setDurationToCloseHeader(3000);
        binding.storeHousePtrFrame.setHeaderView(header);
        binding.storeHousePtrFrame.addPtrUIHandler(header);
        binding.storeHousePtrFrame.setPtrHandler(new PtrHandler() {
            @Override
    ...
    private void loadMoreData() {
        ...
        String url = "https://channelmyanmar.to/movies/" + pageParam;
        viewModel.loadMore(ApiViewModel.ApiType.MORE_MOVIES, url);
    }
