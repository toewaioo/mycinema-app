...
public class MovieModel {
    ...
    public MovieModel(String name, String baseUrl, String imgurl, String imdb, String description, String type) {
        this.name = name;
    ...
    public MovieModel(MovieModel model){
    ...
    public boolean equals(Object o) {
        ...
        // Compare unique identifier like ID
