...
public class NavigationItemView extends RelativeLayout {
    ...
    public NavigationItemView(Context context,int top) {
        this(context,null);
        this.iconMarginTop=top;
    }
    ...
    private void initTitle(){
        ...
        tvTitle.setTypeface(tvTitle.getTypeface(),isCheck ? Typeface.BOLD : Typeface.NORMAL);
        tvTitle.setTextColor( isCheck ? activeTextColor :unactiveTextColor);

    }

    private void initIcon(int top){
