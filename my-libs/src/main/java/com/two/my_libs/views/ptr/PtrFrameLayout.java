...
public class PtrFrameLayout extends ViewGroup {
    ...
    // Add new flag for disabling scrolling
    private final static byte FLAG_DISABLE_SCROLLING = 0x01 << 4;
    ...
    //
    // Add helper method to check scrolling status
    private boolean isScrollingDisabled() {
        return (mFlag & FLAG_DISABLE_SCROLLING) != 0;
    }

    // Methods to enable/disable scrolling
    public void enableScrolling() {
        mFlag &= ~FLAG_DISABLE_SCROLLING;
    }
